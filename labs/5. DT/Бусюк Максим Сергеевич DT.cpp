...
For test 1 accuracy for train is 1, test is 0.948599
For test 2 accuracy for train is 1, test is 0.728753
For test 3 accuracy for train is 1, test is 1
For test 4 accuracy for train is 1, test is 0.983652
For test 5 accuracy for train is 1, test is 0.989177
For test 6 accuracy for train is 1, test is 0.975166
For test 7 accuracy for train is 1, test is 0.989767
For test 8 accuracy for train is 1, test is 0.997921
For test 9 accuracy for train is 1, test is 0.82549
For test 10 accuracy for train is 1, test is 0.947284
For test 11 accuracy for train is 1, test is 0.993159
For test 12 accuracy for train is 1, test is 0.874544
For test 13 accuracy for train is 1, test is 0.754128
For test 14 accuracy for train is 1, test is 0.985334
For test 15 accuracy for train is 1, test is 0.996997
For test 16 accuracy for train is 1, test is 1
For test 17 accuracy for train is 1, test is 0.859855
For test 18 accuracy for train is 1, test is 0.939687
For test 19 accuracy for train is 1, test is 0.793698
For test 20 accuracy for train is 1, test is 0.931458
For test 21 accuracy for train is 1, test is 0.81357
*/
int main() {
    bool test_heigth = false, test_random = false, draw_graph = true;
    if (test_heigth)
        for (int i = 1; i <= 21; i++) {
